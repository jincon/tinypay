 ...
 * @Last Modified time: 2025-08-09 16:53:07+08:00
 */
...
class Baidu
{
    ...
    private static $config = array(
        ...
        'public_key'    => '', // 平台公钥
        'notify_url'    => '', // 支付回调地址
        'log_path'      => './logs/baidu.log', // 日志文件路径
    );
    ...
    public static function find($orderSn, $accessToken)
    {
        ...
        $response = \jincon\Tinypay::get($url, $params);
    ...
    public static function refund($order=[], $type=1)
    {
        ...
        $response = \jincon\Tinypay::post($url, $params);
        $result = json_decode($response, true);
        // // 显示错误信息
